...
export type QuestionValue = ScaleValue | ChoiceValue | TextValue | ImageChoiceValue | DateValue | BooleanValue | RatingValue | NumericValue | FileValue | MatrixValue | RankingValue;
export type QuestionType = 'scale' | 'multipleChoice' | 'text' | 'imageChoice' | 'date' | 'boolean' | 'rating' | 'numeric' | 'file' | 'matrix' | 'ranking' | 'dropdown' | 'contact';
...
export type Question = ScaleQuestion | MultipleChoiceQuestion | TextQuestion | ImageChoiceQuestion | DateQuestion | BooleanQuestion | RatingQuestion | NumericQuestion | FileQuestion | MatrixQuestion | RankingQuestion | DropdownQuestion | ContactQuestion;
